...
from LaQueli import _, _p, online_update_notification_enabled
...
class PreferencesDialog:
    ...
    def __toggle_callback(self, cell, path):
        ...
        if 'kde_shred_menu_option' == path:
            from LaQueli.DesktopMenuOptions import install_kde_service_menu_file
    ...
    def __general_page(self):
        ...
        cb_shred.set_tooltip_text(
            _("Overwriting is ineffective on some file systems and with certain LaQueli operations.  Overwriting is significantly slower."))
