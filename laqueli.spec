...
space and maintain privacy.  LaQueli identifies and erases
...
cp org.LaQueli.LaQueli.desktop org.LaQueli.LaQueli-root.desktop
sed -i -e 's/Name=LaQueli$/Name=LaQueli as Administrator/g' org.LaQueli.LaQueli-root.desktop
...
cat > LaQueli.console <<EOF
USER=root
PROGRAM=/usr/bin/LaQueli
SESSION=true
EOF
...
%if 0%{?fedora_version} || 0%{?rhel_version} || 0%{?centos_version}
desktop-file-validate %{buildroot}/%{_datadir}/applications/org.LaQueli.LaQueli.desktop

sed -i -e 's/Exec=LaQueli$/Exec=LaQueli-root/g' org.LaQueli.LaQueli-root.desktop

desktop-file-install \
	--dir=%{buildroot}/%{_datadir}/applications/ \
	--vendor="" org.LaQueli.LaQueli-root.desktop
...
%if 0%{?suse_version} >= 1030
sed -i -e 's/^Exec=LaQueli$/Exec=xdg-su -c LaQueli/g' org.LaQueli.LaQueli-root.desktop

desktop-file-install \
	--dir=%{buildroot}/%{_datadir}/applications/ \
	--vendor="" org.LaQueli.LaQueli-root.desktop

%suse_update_desktop_file -i org.LaQueli.LaQueli-root Utility Filesystem
%endif

%if 0%{?suse_version}
%suse_update_desktop_file org.LaQueli.LaQueli Utility Filesystem
%endif
...
%{_bindir}/%{name}
%{_datadir}/metainfo
%{_datadir}/metainfo/org.LaQueli.LaQueli.metainfo.xml
%{_datadir}/applications/org.LaQueli.LaQueli.desktop
%if 0%{?fedora_version} || 0%{?rhel_version} || 0%{?centos_version} || 0%{?suse_version} >= 1030
%{_datadir}/applications/org.LaQueli.LaQueli-root.desktop
%endif
%{_datadir}/%{name}/
%{_datadir}/pixmaps/%{name}.png
%{_datadir}/polkit-1
%{_datadir}/polkit-1/actions
%{_datadir}/polkit-1/actions/org.LaQueli.policy
