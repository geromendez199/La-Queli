...
try:
    ...
    from laqueli.GUI import Bleachbit
    HAVE_GTK = True
except ImportError:
    HAVE_GTK = False
...
class ExternalCommandTestCase(common.BleachbitTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        laqueli.online_update_notification_enabled = False
    ...
    def _test_as_non_admin_with_context_menu_path(self, fn_prefix):
        ...
        original = laqueli.Windows.shell.ShellExecuteEx
        def shell_execute_synchronous(lpVerb='', lpFile='', lpParameters='', nShow=''):
            ...
            laqueli.Windows.shell.ShellExecuteEx = original
        ...
        laqueli.Windows.shell.ShellExecuteEx = shell_execute_synchronous
