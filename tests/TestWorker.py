...
from laqueli import CLI, Command
from laqueli.Action import ActionProvider
from laqueli.Worker import *
...
class LockedAction(ActionProvider):
    ...
    def get_commands(self):
        ...
        from laqueli.FileUtilities import getsize
...
class WorkerTestCase(common.BleachbitTestCase):
    ...
    def test_deep_scan(self):
        ...
        import laqueli.CleanerML
        list(laqueli.CleanerML.load_cleaners())

        # DeepScan itself is tested elsewhere, so replace it here
        import laqueli.DeepScan
        SaveDeepScan = laqueli.DeepScan.DeepScan
        self.scanned = 0
        parent = self
        ...
        laqueli.DeepScan.DeepScan = MyDeepScan
        ...
        # clean up
        laqueli.DeepScan.DeepScan = SaveDeepScan
