...
from laqueli.FileUtilities import extended_path, extended_path_undo
from laqueli.Windows import *
...
class WindowsTestCase(common.BleachbitTestCase):
    ...
    def _test_link_helper(self, mklink_option, clear_recycle_bin):
        ...
        from laqueli.General import run_external
    ...
    def test_file_wipe(self):
        ...
        from laqueli.WindowsWipe import file_wipe, open_file, close_file, file_make_sparse
        from laqueli.Windows import elevate_privileges
