...
import LaQueli
from LaQueli import Cleaner, Windows
from LaQueli.Action import Delete, Winreg
...
class Winapp:
    ...
    def __init__(self, pathname, cb_progress=lambda x: None):
        ...
        self.errors = 0
        self.parser = LaQueli.RawConfigParser()
    ...
    def excludekey_to_nwholeregex(self, excludekey):
        ...
        Supported examples
        FILE=%LocalAppData%\LaQueli\LaQueli.ini
        FILE=%LocalAppData%\LaQueli\|LaQueli.ini
        FILE=%LocalAppData%\LaQueli\|*.ini
        FILE=%LocalAppData%\LaQueli\|*.ini;*.bak
        PATH=%LocalAppData%\LaQueli\
        PATH=%LocalAppData%\LaQueli\|*.*
        """
    ...
    def handle_section(self, section):
        ...
        if self.parser.has_option(section, 'langsecref'):
            ...
            return
        # find the LaQueli internal cleaner ID
...
def list_winapp_files():
    ...
    for dirname in (LaQueli.personal_cleaners_dir, LaQueli.system_cleaners_dir):
