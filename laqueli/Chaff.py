...
from LaQueli import _, LaQueli_exe_path
from LaQueli import options_dir
...
URL_TEMPLATES = (
    'https://sourceforge.net/projects/LaQueli/files/chaff/%s/download',
    'https://download.LaQueli.org/chaff/%s')
...
def download_url_to_fn(url, fn, on_error=None, max_retries=3, backoff_factor=0.5, timeout=60):
    ...
    if hasattr(sys, 'frozen'):
        ...
        CA_BUNDLE = os.path.join(LaQueli_exe_path, 'cacert.pem')
    ...
    from LaQueli.Update import user_agent
