...
from LaQueli.FileUtilities import children_in_directory
from LaQueli.Options import options
from LaQueli import Command, FileUtilities, Memory, Special
...
try:
    from LaQueli.GuiBasic import Gtk, Gdk
    ...
    # ValueError seen on LaQueli 3.0 with GTK 3 (GitHub issue 685)
    HAVE_GTK = False


if 'posix' == os.name:
    from LaQueli import Unix
elif 'nt' == os.name:
...
class System(Cleaner):
    ...
    def __init__(self):
        ...
        if 'posix' == os.name:
            ...
            # make up the application menu (the menu that shows LaQueli,
    ...
    def get_commands(self, option_id):
        ...
        if 'nt' == os.name and 'tmp' == option_id:
            ...
            # https://bugs.launchpad.net/LaQueli/+bug/1421726
            for dirname in dirnames:
    ...
    def init_whitelist(self):
        ...
        regexes = [
            ...
            # iBus Pinyin
            # https://bugs.launchpad.net/LaQueli/+bug/1538919
